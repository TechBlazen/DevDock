...
ALTER TABLE forum_threads ADD COLUMN IF NOT EXISTS mcp_server_id TEXT;
ALTER TABLE forum_threads ADD COLUMN IF NOT EXISTS mcp_server_name TEXT;

CREATE INDEX IF NOT EXISTS idx_forum_threads_mcp ON forum_threads(mcp_server_id);
